$(function () {
    ...
    var table = $("#project").DataTable({
        ...
        columns: [
            ...
            { data: "nama_client", name: "nama_client", orderable: false },
            { data: "pic", name: "pic", orderable: false },
            { data: "nominal", name: "nominal", orderable: false },
            { data: "realisasi", name: "realisasi", orderable: false },

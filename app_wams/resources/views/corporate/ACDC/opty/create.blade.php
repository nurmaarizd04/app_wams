...
@section('title', 'Create Project Opty ACDC')
    ...
    <section class="section">
        ...
        <div class="container">
            <div class="card">
                ...
                <form action="{{ route('project-opty-acdc.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Account
                                Manager</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text"
                                    ...
                                    value='{{ old('account_manager', '') }}' required>
                            ...
                            <div class="col-sm-12 col-md-7">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="nominal" class="form-control uang calculate"
                                        value='{{ old('nominal', '') }}' name="nominal" min=1 required autocomplete="off">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text"
                                    ...
                                    value='{{ old('no_penawaran', '') }}' required>
                        ...
                        <div id="dynamicForm">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="date" class="form-control" name="date_trx[]"
                                        placeholder="Tanggal Transaksi" autocomplete="Off" required>
                                    <p class="text-danger">{{ $errors->first('date_trx') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="nama_penerima[]" placeholder="Nama Penerima" autocomplete="Off" required>
                                    <p class="text-danger">{{ $errors->first('nama_penerima') }}</p>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nominal Transaksi</label>
                                <div class="col-sm-12 col-md-7">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Rp</span>
                                        </div>
                                        <input type="text" class="form-control uang" name="nominal_trx[]" min=1 required autocomplete="off">
                ...
                var newRow = `
                    <div class="dynamic-row">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tanggal Transaksi</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="date" class="form-control" name="date_trx[]" placeholder="Tanggal Transaksi" autocomplete="Off" required>
                                <p class="text-danger">{{ $errors->first('date_trx') }}</p>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Jenis Transaksi</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" name="jenis_trx[]" placeholder="Jenis Transaksi" autocomplete="Off" required>
                                <p class="text-danger">{{ $errors->first('jenis_trx') }}</p>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
